import { ReturnCode, TokenPayment } from "@dharitrix/moajs";
import { createAirdropService, createDCTInteractor, FiveMinutesInMilliseconds, INetworkProvider, ITestSession, ITestUser, TestSession } from "@dharitrix/moajs-snippets";
...
describe("lottery snippet", async function () {
    ...
    it("airdrop MOA", async function () {
        this.timeout(FiveMinutesInMilliseconds);

        let payment = TokenPayment.moaFromAmount(0.1);
